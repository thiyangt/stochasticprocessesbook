...
Let $$P_{ij}(t) = P(N(t+s) = j|N(s) = i)\text{ for all }s \geq 0,$$

Further, $P_{ij}(t)$ satisfy,

1. $P_{i, i+1}(h) = \lambda_ih + o(h), i \geq 0$

2. $P_{i, i-1}(h) = \mu_ih + o(h), i \geq 1$

3. $P_{i, i-1}(h) = 1- (\lambda_i + \mu_i)h + o(h), i \geq 0$
